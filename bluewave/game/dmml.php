...
<head>
  ...
  <title>BlueWaves STORE — Mobile Legends</title>
...
<body>
  ...
  <main>
    <form action="" method="post" id="orderForm" enctype="multipart/form-data">
      <!-- USER ID -->
      <input type="hidden" value="Mobile Legends" name="game">
      <div class="card">
        <h3>Masukkan User ID & Server ID ML Anda</h3>
        <div class="user-inputs">
          ...
          <div class="input-group">
            ...
            <input id="serverId" class="input-field" placeholder="Masukkan Server ID" name="serverId">
          </div>
        </div>
      </div>
  ...
  <div id="orderConfirmationPopup" class="popup-overlay" style="display: none;">
    <div class="popup-content">
      ...
      <div class="popup-footer">
        ...
        <button type="button" class="btn btn-secondary" onclick="closeOrderConfirmationPopup()" style="flex: 1;">Batal</button>
      </div>
    </div>
  </div>
  ...
  <script>
    /* ===== PRODUK ===== */
    const sample = [
      [12, '12 Diamonds (11+1 Bonus)',  3546],
      [14, '14 Diamonds (13+1 Bonus)',  4127],
      [18, '18 Diamonds (17+1 Bonus)',  5159],
      [19, '19 Diamonds (17+2 Bonus)',  5572],
      [28, '28 Diamonds (25+3 Bonus)',  8105],
      [36, '36 Diamonds (33+3 Bonus)',  10317],
      [44, '44 Diamonds (40+4 Bonus)',  12157]
    ];
